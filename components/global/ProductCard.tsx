...
const ProductCard = ({ product }: any) => {
  ...
  return (
    <div
      ...
      className="mb-4 p-1 rounded-md group cursor-pointer shadow-lg overflow-y-scroll"
    >
      <div className="hidden md:flex justify-end items-center gap-2 my-2 ">
      ...
      <p className="mt-2 text-start font-semibold text-sm ">{product?.title}</p>
      ...
      <div className="flex flex-col justify-start items-start gap-1 mt-5">
        <p
          className="flex items-center justify-between text-start font-semibold text-sm cursor-pointer"
