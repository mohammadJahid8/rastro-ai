            ...
            {imageUrls?.map((url: string, i: number) => (
              ...
              >
                <Dialog>
                  ...
                  <DialogContent className="!h-[50vh] md:!h-[80vh] md:max-w-[90vw] object-cover lg:max-w-[70vw] border-none">
                    <Image
                      src={url}
                      alt={product?.title_french}
                      quality={100}
                      ...
                      }  !h-[50vh] md:!h-[80vh] object-contain md:object-contain w-full lg:rounded-lg`}
                    />
                  </DialogContent>
                </Dialog>
              </CarouselItem>
